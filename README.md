...
1. How would you describe acessibility on the web to someone new to programming?
   Accessibility on the web means that people with disabilities can utilize a website with ease. Some examples are using semantic HTML for people who use screen readers or even a colorblind mode.
2. Talk about 3 different things you can do to ensure your website is accessible.
   The first way is to use semantic HTML. It benefit people who uses screen readers because the tags are meaningful.
   The second way is to use the alt attribute when adding an image. The alt attribute let the user know that while an image did not load properly, we can describe the image so they do not miss it.
   The third way is to make your website responsive to different screen sizes with media queries.
3. How would you explain the concept of a variable to someone new to programming?
   A variable is a container that holds a value.
4. What is the purpose of using functions in code?
   The purpose of functions is to be able to reuse a block of code instead of writing the same block over and over again.
